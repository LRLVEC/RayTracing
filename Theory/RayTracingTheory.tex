    ...
    \section{理论推导}
        ...
        \subsection{光线效果的模拟}
            ...
            \subsubsection{镜面反射}
                ...
                \indent 而修正为:
                \begin{equation}
                    r'=\frac{r}{2}\left[\left(\frac{n\cos{i_0}-\cos{i_1}}{\cos{i_1}+n\cos{i_0}}\right)^2+
                        \left(\frac{\cos{i_0}-n\cos{i_1}}{n\cos{i_1}+\cos{i_0}}\right)^2\right].
                \end{equation}
                注意到当$i_1$和$i_0$都趋于0时,数值计算可能不精确,于是求极限:
                \begin{equation}
                    \lim_{i_0,i_1\rightarrow 0}\frac{1}{2}\left[\left(\frac{n\cos{i_0}-\cos{i_1}}{\cos{i_1}+n\cos{i_0}}\right)^2+
                    \left(\frac{\cos{i_0}-n\cos{i_1}}{n\cos{i_1}+\cos{i_0}}\right)^2\right]=
            ...
            \subsubsection{折射}
                ...
                \indent 计算菲涅尔透射率:
                \begin{equation}
                    t'=2t\cos^2{i_0}\left[\frac{1}{\left(\cos{i_1}+n\cos{i_0}\right)^2}+
                    \frac{1}{\left(n\cos{i_1}+\cos{i_0}\right)^2}\right].
                \end{equation}
                同理,在$i_1$和$i_0$都趋于0时,计算极限:
                \begin{equation}
                    \lim_{i_0,i_1\rightarrow 0}2\cos^2{i_0}\left[\frac{1}{\left(\cos{i_1}+n\cos{i_0}\right)^2}+
                    \frac{1}{\left(n\cos{i_1}+\cos{i_0}\right)^2}\right]=
                    \left(\frac{2}{1+n}\right)^2.
                \end{equation}
